...
compare_4_args "-a" "127.0.0.1" "register" "pepa"
compare_4_args "register" "pepa" "-a" "127.0.0.1"
compare_3_args "login" "-p" "500"
compare_3_args "logout" "idk" "500"
compare_3_args "logout" "-a" "127.0.0.1"
compare_3_args "-a" "logout" "500"
compare_3_args "send" "idk" "500"
compare_1_args "fetch"
compare_3_args "-a"  "127.0.01" "fetch"
